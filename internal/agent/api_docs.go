...
type SendEmailRequest struct {
	From           string       `json:"from,omitempty" example:"my-bot@agents.e2a.dev"`
...
type AgentInfo struct {
	...
	Domain               string    `json:"domain" example:"agents.e2a.dev"`
	Email                string    `json:"email" example:"my-bot@agents.e2a.dev"`
...
type MessageSummary struct {
	...
	To             string `json:"to" example:"my-bot@agents.e2a.dev"`
...
type DNSRecord struct {
	...
	Value    string `json:"value" example:"e2a.dev"`
...
type PendingMessageSummary struct {
	...
	AgentID           string    `json:"agent_id" example:"my-bot@agents.e2a.dev"`
