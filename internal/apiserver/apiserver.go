...
func BuildDeps(p Params) httpapi.Deps {
	return httpapi.Deps{
		...
		GetWorkspace:           p.Store.GetWorkspace,
		RenameWorkspace:        p.Store.RenameWorkspace,
		ResolveMembership:      p.Store.ResolveMembership,
		ListMembers:            p.Store.ListMembers,
		SetMemberRole:          p.Store.SetMemberRole,
		RemoveMember:           p.Store.RemoveMember,
		IsMemberByEmail:        p.Store.IsMemberByEmail,
		CreateInvitation:       p.Store.CreateInvitation,
		ListPendingInvitations: p.Store.ListPendingInvitations,
		RevokeInvitation:       p.Store.RevokeInvitation,
		AcceptInvitation:       p.Store.AcceptInvitation,
		SendInvitationEmail:    p.API.SendInvitationCore,
		InviteLimit:            p.API.InviteLimitAllow,
