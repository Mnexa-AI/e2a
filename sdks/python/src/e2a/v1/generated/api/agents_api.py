...
class AgentsApi:
    ...
    async def put_agent_protection(
        self,
        email: Annotated[StrictStr, Field(description="The agent's full email address.")],
        protection_config_view: ProtectionConfigView,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param email: The agent's full email address. (required)
        :type email: str
        :param protection_config_view: (required)
        :type protection_config_view: ProtectionConfigView
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_agent_protection_serialize(
            email=email,
            protection_config_view=protection_config_view,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _put_agent_protection_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if protection_config_view is not None:
            _body_params = protection_config_view
