...
class AccountApi:
    ...
    @validate_call
    async def rotate_account_signing_secret(
        self,
        ...
        _param = self._rotate_account_signing_secret_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RotateAccountSigningSecretResponse",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    async def rotate_account_signing_secret_with_http_info(
        self,
        idempotency_key: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RotateAccountSigningSecretResponse]:
        """Rotate the account relay signing secret
    ...
    @validate_call
    async def rotate_account_signing_secret_without_preload_content(
        self,
        idempotency_key: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _rotate_account_signing_secret_serialize(
        self,
        idempotency_key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/account/signing-secret/rotate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
