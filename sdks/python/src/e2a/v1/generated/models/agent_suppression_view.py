...
class AgentSuppressionView(BaseModel):
    """
    ...
    source: StrictStr = Field(description="How the block was created. Known values: unsubscribe, manual.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSuppressionView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSuppressionView from a dict"""
        if obj is None:
            return None
