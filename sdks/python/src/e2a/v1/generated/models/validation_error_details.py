...
class ValidationErrorDetails(BaseModel):
    ...
    """ # noqa: E501
    fields: Optional[List[FieldError]] = Field(description="The fields that failed validation. May be empty when the failure is request-wide rather than field-specific.")
