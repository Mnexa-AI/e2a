...
class MessageView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["auth", "auth_headers", "body", "cc", "conversation_id", "created_at", "delivery_detail", "delivery_status", "flag_reason", "flagged", "from", "labels", "message_id", "parsed", "raw_message", "recipient", "reply_to", "sent_as", "status", "subject", "to"]
