...
export class SendingRampView {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "activeDays",
            "baseName": "active_days",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "dailyRecipientLimit",
            "baseName": "daily_recipient_limit",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "estimatedCompletionAt",
            "baseName": "estimated_completion_at",
            "type": "Date",
            "format": "date-time"
        },
        {
        ...
        {
            "name": "recipientsUsedToday",
            "baseName": "recipients_used_today",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return SendingRampView.attributeTypeMap;
    }
