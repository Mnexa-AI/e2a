...
export class HoldReasonView {
    /**
    * Top screening category when a scan hold has detail enrichment.
    */
    'category'?: string;
    /**
    * Stable machine-readable hold code. Open set; tolerate unknown values.
    */
    'code': string;
    /**
    * Screening confidence from 0 through 1 when available. Intended for expanded technical detail, not the queue summary.
    */
    'confidence'?: number;
    /**
    * Validated plain-language detector rationale when available.
    */
    'detail'?: string;
    /**
    * Plain-language explanation suitable for showing directly to a reviewer.
    */
    'summary': string;
    /**
    * Producer that caused the hold. Open set; tolerate unknown values. Known values: gate, scan, send, unknown.
    */
    'type': string;
    ...
    static getAttributeTypeMap() {
        return HoldReasonView.attributeTypeMap;
    }
