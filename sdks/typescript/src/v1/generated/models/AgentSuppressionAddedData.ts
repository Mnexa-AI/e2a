...
export class AgentSuppressionAddedData {
    'address': string;
    'agentEmail': string;
    /**
    * How the suppression was created. Known values: unsubscribe, manual.
    */
    'source': string;
    ...
    static getAttributeTypeMap() {
        return AgentSuppressionAddedData.attributeTypeMap;
    }
