...
export default function FeedbackPage() {
  ...
  return (
    <section className="max-w-xl">
      ...
      <p className="text-muted mb-8">
        e2a is in beta, your feedback directly shapes what we build. Bug reports, feature requests,
        or anything else. You can also reach us at{" "}
        <a href="mailto:info@e2a.dev" className="text-accent hover:underline">info@e2a.dev</a>.
      </p>
