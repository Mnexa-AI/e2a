      ...
      <section id="how-it-works" style={{ padding: "56px 32px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <div className="steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)" }}>
            {[
              { num: "1", title: "Register your agent", desc: "Sign in and choose a shared address on agents.e2a.dev, or bring your own domain for more control.", tag: "e2a agents register my-agent" },
          ...
          <div className="code-block" style={{ background: "#1C1A17", borderRadius: 10, padding: "24px 28px", fontFamily: "'IBM Plex Mono', monospace", fontSize: 12.5, lineHeight: 1.8, overflowX: "auto" }}>
            {activeTab === "cli" && (
              <div>
                ...
                <div style={{ color: "#E8E0D4" }}>e2a listen <span style={{ color: "#8BAF6E" }}>--agent</span> my-agent@agents.e2a.dev <span style={{ color: "#8BAF6E" }}>--forward</span> http://localhost:3000</div>
              </div>
            )}
            {activeTab === "claude" && (
              <div>
            ...
            {activeTab === "python" && (
              <div>
                ...
                <div style={{ color: "#E8E0D4" }}><span style={{ color: "#C9956C" }}>async for</span> msg <span style={{ color: "#C9956C" }}>in</span> client.<span style={{ color: "#7EAACF" }}>listen</span>(<span style={{ color: "#8BAF6E" }}>{'"my-agent@agents.e2a.dev"'}</span>):</div>
            ...
            {activeTab === "webhook" && (
              <div>
                ...
                <div style={{ color: "#E8E0D4" }}>curl -X POST https://e2a.dev/api/v1/agents \</div>
