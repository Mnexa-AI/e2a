...
const DOCS_LINKS: { label: string; href: string; external?: boolean }[] = [
  ...
  { label: "Claude Code skill", href: "https://github.com/Mnexa-AI/e2a/blob/main/skills/email/SKILL.md", external: true },
...
const FOOTER_LINKS: { label: string; href: string; external?: boolean }[] = [
  ...
  { label: "TypeScript SDK", href: "https://www.npmjs.com/package/@e2a/sdk", external: true },
  { label: "CLI", href: "https://www.npmjs.com/package/@e2a/cli", external: true },
  { label: "Claude Skill", href: "https://github.com/Mnexa-AI/e2a/blob/main/skills/email/SKILL.md", external: true },
          ...
          <CodeBlock>
            ...
            {activeTab === "claude" && (
              <>
                ...
                <Line>&nbsp;&nbsp;https://raw.githubusercontent.com/Mnexa-AI/e2a/main/skills/email/SKILL.md</Line>
                <Line>&nbsp;</Line>
